...
def create_register_booking() -> RegisterBooking:
    ...
    return RegisterBooking(
        RegisterBookingUoW(db_manager),
        PassengerProcessor(),
        RegisterBookingValidator(base_validator, flight_validator, passenger_validator),
    )
...
def create_booking(
    ...
    register_booking: RegisterBooking = Depends(create_register_booking),
):
