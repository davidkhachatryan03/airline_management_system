...
class RegisterBooking:
    ...
    def execute(self, booking_request: BookingRequest) -> BookingResponse:
        with self.uow as uow:
            ...
            self.register_booking_validator.validate_data_logic(flights_requested_id, flights_retrieved_id)
            ...
            self.register_booking_validator.validate_business_logic(all_passengers, flights_retrieved, seats_available_per_flight)
