...
def booking_request() -> BookingRequest:
    return BookingRequest(
        flights_id=[
            UUID("019f60a9-c89e-7138-b9c4-3e554055cee0"),
            UUID("019f60aa-338d-799b-9f43-134050b58020"),
        ],
        passengers=[
            PassengerRequest(
...
@pytest.fixture
def passengers_and_documents_generated(
    booking_request: BookingRequest,
) -> tuple[list[Passenger], list[Document]]:
