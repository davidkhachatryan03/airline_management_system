...
@pytest.fixture
def flight_request(
    route_generated: Route, airplane_generated: Airplane
) -> FlightRequest:
...
@pytest.fixture
def flight_generated(
    flight_request: FlightRequest, airplane_generated: Airplane, route_generated: Route
) -> Flight:
