...
def create_register_flight(fake_uow: FakeRegisterFlightUoW) -> RegisterFlight:
    return RegisterFlight(
        ...
        register_flight_validator=RegisterFlightValidator(BaseValidator(), FlightValidator())
    )

@pytest.mark.usefixtures("fixed_flight_identifiers")
def test_register_flight_valid_input(flight_request: FlightRequest, route_generated: Route, airplane_generated: Airplane, expected_flight_id: FlightId) -> None:
...
def test_register_flight_inexistent_airplane(flight_request: FlightRequest, route_generated: Route) -> None:
    fake_uow = FakeRegisterFlightUoW(FakeDBManager())
...
def test_register_flight_unavailable_airplane(flight_request: FlightRequest, route_generated: Route, unavailable_airplane: Airplane) -> None:
    fake_uow = FakeRegisterFlightUoW(FakeDBManager())
...
def test_register_flight_inexistent_route(flight_request: FlightRequest, airplane_generated: Airplane) -> None:
    fake_uow = FakeRegisterFlightUoW(FakeDBManager())
...
def test_register_flight_duplicated_flight(flight_request: FlightRequest, flight_generated: Flight, route_generated: Route, airplane_generated: Airplane) -> None:
    fake_uow = FakeRegisterFlightUoW(FakeDBManager())
