...
def test_register_document_use_case_valid_input(document_request: DocumentRequest, document_generated: list[Document], passenger_generated: list[Passenger]) -> None:
