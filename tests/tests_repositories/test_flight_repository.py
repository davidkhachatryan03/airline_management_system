...
def test_insert_flight(flight_repository: FlightRepository, flight: Flight) -> None:
    ...
    assert last_inserted_flight.scheduled_departure_datetime == flight.scheduled_departure_datetime
    assert last_inserted_flight.scheduled_arrival_datetime == flight._scheduled_arrival_datetime
    assert last_inserted_flight.actual_departure_datetime == flight.actual_departure_datetime
    assert last_inserted_flight.actual_arrival_datetime == flight.actual_arrival_datetime
...
def test_retrieve_all_flights(flight_repository: FlightRepository, flights: list[Flight]) -> None:
