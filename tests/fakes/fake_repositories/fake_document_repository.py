...
class FakeDocumentRepository:
    ...
    def retrieve_by_identity_keys(
        ...
        document_stored_identity_keys: dict[DocumentIdentityKey, Document] = {
            document.identity_key: document for document in self.documents
        }
        for document_identity_key in documents_identity_keys:
            if document_identity_key in document_stored_identity_keys:
                documents_retrieved.append(
                    document_stored_identity_keys[document_identity_key]
                )
